# Generated by Django 4.1 on 2023-05-01 05:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profilePic', models.ImageField(blank=True, null=True, upload_to='profileImage')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=1000, null=True, unique_for_date='publish')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.expressions.Case, related_name='postCategory', to='core.category')),
            ],
            options={
                'ordering': ['-publish'],
            },
